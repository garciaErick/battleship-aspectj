...
public class BattleBoard {
    ...
    private static List<Battleship> defaultShips() {
        return Arrays.asList(new Battleship[] { 
     ...
     * @see Battleship
     */
    public BattleBoard(int size, Iterable<Battleship> ships) {
        this.size = size;
        numOfShots = 0;
     ...
     * @see Battleship
     */
    public boolean placeShip(Battleship ship, int x, int y, boolean dir) {
    	int len = ship.size();
    	if (dir // horizontal? 
     ...
     * @see Place
     */
    public boolean placeShip(Battleship ship, Place place, boolean dir) {
     ...
     * @param numOfShots Total number of shots
     */
    private void notifyGameOver(int numOfMoves) {
    	for (BoardChangeListener listener: listeners) {
    	    listener.gameOver(numOfMoves);
    	}
    }
